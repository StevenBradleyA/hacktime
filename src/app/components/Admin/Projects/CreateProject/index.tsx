...
export default function CreateProject({ closeModal }: CreateProjectProps) {
  ...
  return (
    <div className=" relative flex h-[600px] w-[700px] flex-col overflow-auto text-red-600 desktop:h-[750px]">
      <Image
        alt="admin logo"
        src={anon}
      ...
      <form className="mt-5 flex w-full flex-col gap-5">
        ...
        <label className="relative flex justify-center">
          ...
          />
          <button className="w-3/4 rounded-md bg-darkGray p-5 text-2xl">
            CLICK ME
          </button>
        </label>

...
export default function Home() {
  ...
  return (
    <>
      ...
      <h1 className="absolute left-1/4 top-16 z-30 flex-col text-4xl desktop:top-8 desktop:text-5xl">
        <div>We build bespoke web</div>
        <div> experiences, turning your </div>
        <div>visions into online reality</div>
      </h1>

      <div className="relative mt-12 h-[70vh] w-full flex-col items-center justify-center px-24 laptop:h-[78vh] desktop:h-[85vh] ">
      ...
      <div className="relative mt-16 flex w-full flex-col overflow-hidden px-24">
        ...
        <div className="back-layout relative left-1/2 top-10 z-10 w-full -translate-x-1/2 text-sm desktop:w-5/6">
          <Image
            src={hacktime}
            alt="hacktime logo "
          ...
          <Image
            src={hackBarCode}
            alt="hacktime logo "
            className=" png-light-gray absolute -right-10 top-4 h-7 w-64 object-cover desktop:-right-32"
          />
          <svg
            xmlns="http://www.w3.org/2000/svg"
            xmlnsXlink="http://www.w3.org/1999/xlink"
          ...
          <div className="absolute left-1/2 top-0 z-10  w-5/6 -translate-x-1/2 desktop:top-10 desktop:w-full">
        ...
        <div className=" relative left-[55%] top-24   z-30 flex w-full flex-col">
          <h2 className="text-5xl text-neonTeal desktop:text-8xl ">
            FREELANCE-
          </h2>
          <h2 className="text-5xl text-neonTeal desktop:text-8xl ">
            DEVELOPERS
        ...
        <div className="z-30 ml-[15%] mt-24 flex w-full flex-col text-neonTeal ">
          ...
          <p className="-mb-8 text-white desktop:-mb-16">
            Your success is our success.
          </p>
          <h2 className="-mb-20 text-[8rem] desktop:-mb-32 desktop:text-[12rem] ">
            UNIQUE-
          </h2>
          <h2 className="text-[8rem] desktop:text-[12rem] ">DESIGNS</h2>
        </div>
      </div>

      <div className=" z-20 flex h-[80vh] w-full justify-between bg-darkGray px-24 text-3xl text-purple-500 desktop:h-[65vh]">
        <div className="h-2/3 w-96 rounded-lg bg-black p-10">
          <p>
            Custom domain SEO, payment integration, subscriptions, email, text
            confirmations, Cloud Image storage. Reviews, comments
          </p>
        </div>

        <div className="mt-20 h-2/3 w-96 rounded-lg bg-black p-10">
          <p>
            We design, code , and deliver products that look good on all layouts
          </p>
        </div>

        <div className="mt-40 h-2/3 w-96 rounded-lg bg-black p-10">
          <p>Custom Admin features to manage transactions, users, etc. </p>
        </div>
      </div>

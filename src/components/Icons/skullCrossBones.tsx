const SkullCrossBones = () => (
  <>
    ...
    >
      ...
      <g>
        <path d="M17,24H7c-0.6,0-1-0.4-1-1v-5c-2.5-1.9-4-4.8-4-8C2,4.5,6.5,0,12,0s10,4.5,10,10c0,3.2-1.5,6.1-4,8v5C18,23.6,17.6,24,17,24z M8,22h8v-4.5c0-0.3,0.2-0.6,0.4-0.8c2.2-1.5,3.6-4,3.6-6.6c0-4.4-3.6-8-8-8s-8,3.6-8,8c0,2.7,1.3,5.2,3.6,6.6C7.8,16.8,8,17.1,8,17.5V22z" />
      </g>
      <g>

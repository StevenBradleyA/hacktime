  ...
  return (
    <>
      <div className="desktop:w-1/2 mb-40 w-2/3 text-white/40">
        ...
        <h3 className="text-darkGray mb-2 text-xl ">Personal Information</h3>
        <p className="bg-keebyGray mb-5 rounded-md p-5  ">
        ...
        <h3 className="text-darkGray mb-2 text-xl ">Password Security</h3>
        <p className="bg-keebyGray mb-5 rounded-md p-5  ">
        ...
        <h3 className="text-darkGray mb-2 text-xl ">Data Security</h3>
        <p className="bg-keebyGray mb-5 rounded-md p-5  ">
          We have implemented measures designed to secure your personal
          information from accidental loss and from unauthorized access, use,
          alteration, and disclosure. All payment transactions are conducted
          through our third-party payment processor, PayPal, which uses its own
          secure and encrypted channels.
        </p>
        <h2 className="mb-5 text-4xl text-green-500 ">
          How We Use Your Information
        </h2>
        <p className="bg-keebyGray mb-5 rounded-md p-5  ">{`We use the information that we collect about you or that you provide to us, including any personal information: to present our Website and its contents to you; to provide you with information, products, or services that you request from us; to fulfill any other purpose for which you provide it; to carry out our obligations and enforce our rights arising from any contracts entered into between you and us, including for billing and collection; to notify you about changes to our Website or any products or services we offer or provide though it; in any other way we may describe when you provide the information; and for any other purpose with your consent.`}</p>

        <h3 className="text-darkGray mb-2 text-xl ">
          Sharing Of Your Information
        </h3>

        <p className="bg-keebyGray mb-5 rounded-md p-5  ">
          We do not sell or rent your personal information to third parties.
          However, we may share personal information with third parties for
          certain purposes, such as processing transactions via PayPal,
          providing advertising on our platform, for analytics and improvement
          of our services, and as required by law.
        </p>
        <h3 className="text-darkGray mb-2 text-xl ">Providing Services</h3>
        <p className="bg-keebyGray mb-5 rounded-md p-5  ">{`We use your personal information to provide you with the services you request, such as purchasing or selling keyboards, and communicating with you about your purchases. `}</p>

        <h3 className="text-darkGray mb-2 text-xl ">
          Publicly Visible Information
        </h3>
        <p className="bg-keebyGray mb-5 rounded-md p-5  ">
          Some of your activities on our Website, including posting comments,
          keeb type game results, and creating social media posts about
          keyboards, are public by nature. When you create an account, your
          username and any content you post under that account will be visible
          to other users of the Website. Additionally, participating in our
          typing games may result in your game results, including scores and
          rankings, being publicly displayed alongside your username. Please be
          mindful of your privacy and security when deciding what information to
          share as part of your public profile and posts.
        </p>
        ...
        <h3 className="text-darkGray mb-2 text-xl ">Service Providers</h3>
        <p className="bg-keebyGray mb-5 rounded-md p-5  ">
        ...
        <h3 className="text-darkGray mb-2 text-xl ">Legal Compliance</h3>
        <p className="bg-keebyGray mb-5 rounded-md p-5  ">
        ...
        <h2 className="mb-5 text-4xl text-green-500 ">What are Cookies?</h2>
        <p className="bg-keebyGray mb-5 rounded-md p-5  ">
        ...
        <h3 className="text-darkGray mb-2 text-xl ">Cookie Policy</h3>
        <p className="bg-keebyGray mb-5 rounded-md p-5 ">
          {`This Cookie Policy explains how Keeby ("we", "us", or "our") uses cookies on our website www.HackTime ("Site"). By using our Site, you consent to the use of cookies as described in this Cookie Policy.`}
        </p>

        <h2 className="mb-5 text-4xl text-green-500 ">How We Use Cookies</h2>

        <p className="bg-keebyGray mb-5 rounded-md p-5  ">{` We use cookies to keep you signed in and to remember your active settings. This allows us to provide you with a more personalized experience and saves you time by eliminating the need to re-enter information.`}</p>
        <h3 className="text-darkGray mb-2 text-xl ">
          Performance and Analytics
        </h3>
        <p className="bg-keebyGray mb-5 rounded-md p-5  ">{`We use cookies to collect information about how you interact with our Site, including the pages you visit and any errors you may encounter. This helps us improve the performance and functionality of our Site and better understand how our users navigate and use our services. `}</p>
        <h3 className="text-darkGray mb-2 text-xl ">Third-Party Cookies</h3>
        <p className="bg-keebyGray mb-5 rounded-md p-5  ">{`We may also allow third-party service providers, such as Google Analytics, to use cookies on our Site to analyze traffic and usage patterns. These cookies are subject to the privacy policies of these third parties. `}</p>

        <h2 className="mb-5 text-4xl text-green-500 ">Managing Cookies</h2>

        <p className="bg-keebyGray mb-5 rounded-md p-5  ">{`You can control and manage cookies in various ways. Please note that disabling cookies may affect the functionality of our Site and may prevent you from accessing certain features. Most web browsers allow you to control cookies through their settings. You can usually find these settings in the "Options" or "Preferences" menu of your browser. For more information, refer to your browser's help documentation. You can opt out of certain cookies by using the opt-out tools provided by third-party analytics providers, such as Google Analytics.`}</p>

        <h2 className="mb-5 text-4xl text-green-500 ">
          Changes to Our Privacy Policy
        </h2>
        <p className="bg-keebyGray mb-5 rounded-md p-5  ">
          {` HackTime may revise this Privacy Policy at any time without prior notice. The updated
        ...
        <p className="bg-keebyGray mb-5 rounded-md p-5  ">{`If you have any questions about this Cookie Policy or our use of cookies, please contact us at hacktimesupport@outlook.com.`}</p>
      </div>
